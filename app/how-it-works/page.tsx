        ...
        <div style={{ minHeight: '100vh', background: 'var(--bg-base)', fontFamily: 'var(--font-body)', position: 'relative', overflowX: 'hidden' }}>
            ...
            <main style={{ position: 'relative', zIndex: 1, padding: '120px max(1.25rem, 4vw) 80px', maxWidth: 900, margin: '0 auto' }}>
                ...
                <section style={{ marginBottom: '6rem' }}>
                    <FadeIn y={20} style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '2.5rem' }}>
                    ...
                    <StaggerContainer className="flex-col-gap-1" style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                        {[
                            {
                            ...
                            <StaggerItem key={i}>
                                <ScaleHover>
                                    <div className="glass-card" style={{ padding: 'clamp(1.25rem, 5vw, 2rem)', display: 'flex', gap: '1.25rem', flexWrap: 'wrap', transition: 'all 0.3s' }}>
                ...
                {/* ─── FOR STUDENTS ─── */}
                <section style={{ marginBottom: '6rem' }}>
                    <FadeIn y={30} style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '2.5rem' }}>
                    ...
                    <StaggerContainer className="journey-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '1.25rem' }}>
                        {[
                ...
                <section style={{ marginBottom: '6rem' }}>
                    ...
                    <StaggerContainer style={{ display: 'flex', flexDirection: 'column', gap: '0.625rem' }}>
                        {[
                            ...
                            <StaggerItem key={i}>
                                <details className="glass-card" style={{ padding: '1.5rem', borderRadius: 16, cursor: 'pointer' }}>
                ...
                {/* CTA */}
                <FadeIn delay={0.2} style={{ textAlign: 'center', background: 'linear-gradient(180deg, rgba(99,102,241,0.05) 0%, transparent 100%)', border: '1px solid rgba(99,102,241,0.15)', borderRadius: 24, padding: '4rem 2rem' }}>
